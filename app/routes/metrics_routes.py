...
def calculate_saliency(current_user):
    ...
    billoards_q = """
            SELECT 
                b.id, b.video_id, b.distance_to_center, b.average_areas, b.central_duration,
    ...
    try:
        ...
        if billboards is not None:
            for bill in billboards:
                ...
                focal_vision_duration_front = metrics.calculate_focal_vision_duration(bill.get("central_duration"), weights_front.get("focal_vision_duration"))
                ...
                distance_to_center_rear = metrics.calculate_distance_to_center_rear(bill.get("distance_to_center"), weights_rear.get("distance_to_center"))
                average_areas_rear = metrics.calculate_average_areas(bill.get("average_areas"), weights_rear.get("average_areas"))
                focal_vision_duration_rear = metrics.calculate_focal_vision_duration(bill.get("central_duration"), weights_rear.get("focal_vision_duration"))
